...
public class Solution {
    ...
    public static class Rectangular_Love {
    ...
    public static Rectangle findRectangularOverlap(Rectangle rect1, Rectangle rect2) {
        ...
        if(rect1_topY==rect2.getBottomY() || rect1_rightX==rect2.getLeftX()) return new Rectangle();
        else if(res_width<0 || res_height<0) return new Rectangle();
