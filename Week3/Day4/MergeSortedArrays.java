...
public class MergeSortedArrays {
    ...
    public static int[] mergeArrays(int[] myArray, int[] alicesArray) {
        ...
        int i=0,j=0,k=0,l1=myArray.length,l2=alicesArray.length;
        if(l1 ==0 && l2 == 0) return new int[] {};
        else if(l1==0) return alicesArray;
        else if(l2==0) return myArray;
        else{
            int a[]=new int[l1+l2];
            while(i<l1 && j<l2){
